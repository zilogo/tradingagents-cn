  ...
  'analysis-principles': [
    {
      ...
      title: '多智能体系统详解',
      description: '深入理解EOS3-Trader的多智能体协作机制',
      readTime: '15分钟',
      views: 1654,
      difficulty: 'warning',
      difficultyText: '进阶'
  ...
  'resources': [
    {
      ...
      description: '了解EOS3-Trader的源项目TradingAgents的架构和特性',
      readTime: '15分钟',
      views: 1432,
      difficulty: 'warning',
      difficultyText: '进阶'
  ...
  'tutorials': [
    {
      id: 'getting-started',
      title: '快速入门教程',
      description: '从零开始学习如何使用EOS3-Trader进行股票分析',
      readTime: '10分钟',
      views: 3456,
      difficulty: 'success',
      difficultyText: '入门'
    },
    {
      ...
      title: '使用指南（试用版）',
      description: 'EOS3-Trader v1.0.0-preview 使用指南与试用说明',
      readTime: '15分钟',
      views: 1288,
      difficulty: 'success',
      difficultyText: '入门'
